...
BEGIN
    ...
    PROCESS (death_drawn, death_sprite_color, pause_drawn, pause_sprite_color, show_djt,
             player_drawn, sprite_color, missile_drawn, missile_sprite_color, coin_drawn,
             coin_sprite_color, base_color_d, combined_laser_is_transparent, combined_laser_color)
